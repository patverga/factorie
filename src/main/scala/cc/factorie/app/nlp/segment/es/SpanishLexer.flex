...
/**
 *  A tokenizer for Spanish adapted from EnglishLexer.flex
 */
...
HONORIFIC_EN = Adm|Attys?|Brig|Capts?|Cols?|Comms?|Co?mdrs?|Cpls?|Cpts?|Det|Drs?|Hon|Gens?|Govs?|Lieuts?|Lts?|Majs?|Miss|Messrs|Mr|Mrs|Ms|Pfc|Pres|Profs?|Pvts?|Reps?|Revs?|Sens?|Sgts?|Spc|Supts?
HONORIFIC_ES = Sr|Sra|Srta|D|Da|D[\u00F1n]a|Dr|Dra|Prof|Profa|Gob|Gral|Av|Avda|apdo|Esq|Uds?|Vds?
HONORIFIC = {HONORIFIC_EN}|{HONORIFIC_ES}
 ...
 */
VB_2PP_PRON = ({LETTER}*)[aeiáéí]((d{ATTACHED_PRON})|{OS})
